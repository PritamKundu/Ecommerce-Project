				  ...
				  <tbody>
				      ...
				      <td>
				      	...
				      	<div class="form-group">
				      		<a href="{{route('editbrands', $brand->id)}}" class="btn btn-success btn-sm">Update</a>

				      		<button type="submit" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deletebrand{{$brand->id}}">Delete</button>
				      	</div>
