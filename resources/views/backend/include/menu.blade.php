      ...
      <ul class="br-sideleft-menu">
        ...
        <li class="br-menu-item">
          <a href="#" class="br-menu-link with-sub">
            ...
            <span class="menu-item-label">Manage Catagory</span>
          </a><!-- br-menu-link -->
          <ul class="br-menu-sub">
            <li class="sub-item"><a href="{{route('managecategories')}}" class="sub-link">All Catagories</a></li>
            <li class="sub-item"><a href="{{route('createcategories')}}" class="sub-link">Add New Category</a></li>
          </ul>
        </li>
        <!-- Manage Category End -->
        ...
        <li class="br-menu-item">
          ...
          <ul class="br-menu-sub">
            <li class="sub-item"><a href="{{route('managebrands')}}" class="sub-link">All Brand</a></li>
            <li class="sub-item"><a href="{{route('createbrands')}}" class="sub-link">Add New Brand</a></li>
          </ul>
        </li>
        <!-- Manage Brand End -->
