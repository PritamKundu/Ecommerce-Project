  ...
  <body>
    ...
    <div class="d-flex align-items-center justify-content-center bg-br-primary ht-100v">
      ...
      <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base">
        ...
        <div class="mg-t-60 tx-center">Not yet a member? <a href="{{asset('register')}}" class="tx-info">Sign Up</a></div>
        <div class="mg-t-20 tx-center">Aleardy a member? <a href="{{asset('register')}}" class="tx-info">Sign In</a></div>
      </div><!-- login-wrapper -->
    </div><!-- d-flex -->
